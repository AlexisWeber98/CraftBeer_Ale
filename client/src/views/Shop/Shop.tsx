...
const Shop = () => {
  ...
  itemCart.forEach((element) => {
    if (!element.hasOwnProperty("user")) sumItem = sumItem + element.quantity;
  });
    ...
    <Container>
      <div className={style.search}>
        ...
        <button
          ...
          disabled={disableBoton.search}
          onClick={handlerClick}>
          🔍
        </button>
        <button className={style.buttonAll} onClick={handlerClick}>
          All
        </button>
        ...
        {rol.accessLogin.role !== "Company" && (
          <Link to={"/cart"}>
            <div className={style.imageCart}>
              ...
              <div className={style.imageCartdiv}>{sumItem}</div>
            </div>
          </Link>
        )}
      </div>
      <Row>
        <Col
          ...
          <div
            ...
            <button
              className={style.button_Pagechange}
              onClick={handlerPage}
              name="<"
              disabled={disableBoton.back}>
              {"<"}{" "}
            </button>
            <button className={style.button_Pagelateral}>
              {numberPage === 1 ? <></> : numberPage - 1}{" "}
            </button>
            <button className={style.button_Page}> {numberPage} </button>
            <button className={style.button_Pagelateral}>
              {numberPage < pages ? numberPage + 1 : <></>}{" "}
            </button>
            <button
              className={style.button_Pagechange}
              onClick={handlerPage}
          ...
          <div className={style.containerpublicidad}>
            <img
              src="https://thumbs.gfycat.com/IlliteratePoliteLeech-size_restricted.gif"
              alt=""
              style={{ objectFit: "cover", width: "100%" }}
            />
          </div>
          <div className={style.containerpublicidad}>
            <img
              src="https://i.pinimg.com/originals/77/81/ae/7781ae6ad9627464d20fc605b774e6a9.gif"
              alt=""
              style={{ objectFit: "cover", width: "100%" }}
            />
          </div>
          <div className={style.containerpublicidad}>
            <img
              src="https://unapausaparalapublicidad.files.wordpress.com/2014/08/san-miguel.gif"
              alt=""
              style={{ objectFit: "cover", width: "100%" }}
            />
          </div>
