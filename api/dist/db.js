...
const { DB_USER, DB_PASSWORD, DB_HOST, DATABASE_URL, ENVIRONMENT, FLY_POSTGRES_HOST, FLY_POSTGRES_PORT, FLY_POSTGRES_DB, FLY_POSTGRES_USER, FLY_POSTGRES_PASSWORD, CONN_STRING, } = process.env;
const sequelize = new sequelize_1.Sequelize(`${CONN_STRING}`, {
    logging: false,
    native: false,
});
